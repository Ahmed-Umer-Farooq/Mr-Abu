  ...
  return (
    <ErrorBoundary>
      ...
      <div className="relative z-10">
        ...
        {/* Lifetime Analytics */}
        <section id="stats" className="relative pt-32 pb-24 px-6">
        ...
        <section id="audience" className="relative py-24 px-6">
          <div className="container mx-auto max-w-7xl">
            <div className="mb-12 text-center">
              <div className="inline-block relative">
                <div className="absolute inset-0 bg-gradient-to-r from-primary to-secondary blur-xl opacity-50" />
        ...
        {/* Viral Shorts */}
        <section id="shorts" className="relative py-24 px-6">
          <div className="container mx-auto max-w-7xl">
            <div className="mb-12 text-center">
              <div className="inline-block relative">
                <div className="absolute inset-0 bg-gradient-to-r from-primary to-secondary blur-xl opacity-50" />
        ...
        {/* Contact CTA */}
        <section id="collaborate" className="relative py-24 px-6">
